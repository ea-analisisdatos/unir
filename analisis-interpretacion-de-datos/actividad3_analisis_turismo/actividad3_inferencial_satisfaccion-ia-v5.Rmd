...
>
> - Sitio web del proyecto [(versión navegable)](https://ea-analisisdatos.github.io/projects-and-pages/actividad3-analisis-inferencial/  "Ir a la fuente")
>
> - El código fuente y archivos asociados están disponibles en el repositorio:
GitHub: [ea-analisisdatos/unir](https://github.com/ea-analisisdatos/unir/tree/main/analisis-interpretacion-de-datos/actividad3_analisis_turismo "Repositorio Github de Erika Alvares")
